...
// import { useCart, Item as CartItem, addToCart } from '../Context/CartContext';
...
//   const { addToCart }: { addToCart: addToCart } = useCart();

//   const items: Item[] = [
//     { id: 1, content: 'Elegant Diamond Ring', name: 'Diamond Ring', image: item1, price: 500 },
//     { id: 2, content: 'Luxury Gold Necklace', name: 'Gold Necklace', image: item2, price: 800 },
//     { id: 3, content: 'Sapphire Gemstone Earrings', name: 'Gemstone Earrings', image: item3, price: 600 },
//   ];
